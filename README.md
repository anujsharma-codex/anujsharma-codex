<!-- HEADER ANIMATION — CYBERPUNK -->
<img src="https://capsule-render.vercel.app/api?type=venom&color=0:0d0017,30:2d0060,70:7b00ff,100:ff00ff&height=200&section=header&text=Anuj%20Sharma&fontColor=f0d6ff&fontSize=52&fontAlignY=55&desc=Climate%20Data%20Science%20%E2%80%94%20in%20progress.&descFontColor=da8fff&descAlignY=75&descSize=16&animation=fadeIn" width="100%"/>

<!-- TYPING ANIMATION -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=16&duration=2800&pause=1200&color=FF00FF&center=true&vCenter=true&width=680&lines=Building+domain-specific+tools+for+climate+risk.;Python+%E2%86%92+NumPy+%E2%86%92+Pandas+%E2%86%92+Xarray+%E2%86%92+Climate+Systems.;Focus%3A+Energy+transition+%C2%B7+Physical+risk+analytics.;Phase+2+active+%E2%80%94+NumPy+done.+Pandas+loading...;Clean+code.+Real+logic.+No+shortcuts." alt="Typing SVG" />
</p>

<!-- BADGES -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=anujsharma-codex&style=for-the-badge&color=7b00ff&labelColor=0d0017&label=PROFILE+VIEWS"/>
  &nbsp;
...
| Phase | Status | Focus |
|---|---|---|
| Phase 1 — Solar Financial Calculator | ✅ Complete | Python · OOP · CLI · Real financial logic |
| Phase 2 — Scientific Python Stack | 🔄 Active | NumPy → Pandas → Xarray |
| Phase 3 — Geospatial + Climate Data | ⬜ Next | PostGIS · Climate datasets |
...
> A CLI tool for solar potential and financial analysis. Residential and commercial.  
> Config-driven. Real financial logic. Clean OOP with separated physical, energy, and financial layers.

**What it actually does:**

```
Input  →  location, panel specs, system size, segment (residential / commercial)

Physical Layer   →  panel feasibility, orientation, shading analysis
Energy Layer     →  daily / monthly / annual generation estimates
Financial Layer  →  ROI, payback period, LCOE, net cost after subsidy
```

**Architecture decisions:**
- All market rates, GST values, subsidy logic in one config file — change market conditions without touching logic
...
<p align="center"><sub>Active Stack</sub></p>

<p align="center">
  <img src="https://skillicons.dev/icons?i=postgres,docker,fastapi,kubernetes&theme=dark&perline=8" />
</p>
<p align="center"><sub>Roadmap — next 6 months</sub></p>

**Active**

![Python](https://img.shields.io/badge/Python-intermediate-ff00ff?style=flat-square&logo=python&logoColor=white&labelColor=2d0060)
![NumPy](https://img.shields.io/badge/NumPy-basics-ff00ff?style=flat-square&logo=numpy&logoColor=white&labelColor=2d0060)
![OOP](https://img.shields.io/badge/OOP-classes%20%C2%B7%20inheritance%20%C2%B7%20composition-ff00ff?style=flat-square&labelColor=2d0060)
![Git](https://img.shields.io/badge/Git%2FGitHub-active-ff00ff?style=flat-square&logo=github&logoColor=white&labelColor=2d0060)

**Learning — next 6 months**

![Pandas](https://img.shields.io/badge/Pandas-in%20progress-da8fff?style=flat-square&logo=pandas&logoColor=white&labelColor=5500bb)
![Xarray](https://img.shields.io/badge/Xarray-queued-c77dff?style=flat-square&labelColor=7b00ff)
![Matplotlib](https://img.shields.io/badge/Matplotlib-queued-c77dff?style=flat-square&labelColor=7b00ff)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-queued-c77dff?style=flat-square&logo=postgresql&logoColor=white&labelColor=7b00ff)
![PostGIS](https://img.shields.io/badge/PostGIS-queued-c77dff?style=flat-square&labelColor=7b00ff)
![ML](https://img.shields.io/badge/ML%20%E2%80%93%20LSTM%20%C2%B7%20Transformers-planned-e0aaff?style=flat-square&labelColor=9d00ff)
...
Climate Physical Risk Intelligence
  ...
  └── Data-driven decisions for renewables
  └── Geospatial climate risk modeling (building toward)
```
